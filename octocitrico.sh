...
OCTOPI_REPO="https://github.com/denpat/Octoprint138WASP.git" #the cooler one from Denis
...
echo_green "Done!"
EOF
    # Add additional packages to build
...
BOARDS=( "bpim2z" )
echo "==============================="
echo "Build OctoWasp For The bpim2z"
echo "==============================="
